...
class Appointments(Resource):
    ...
    def post(self):
        ...
        appointment = {
            ...
            "address": next((it for it in appointment_raw if it["name"] == "address_1")).get("value"),
            "city": next((it for it in appointment_raw if it["name"] == "city")).get("value"),
            "state": next((it for it in appointment_raw if it["name"] == "state")).get("value"),
            "zip": next((it for it in appointment_raw if it["name"] == "zip")).get("value"),
